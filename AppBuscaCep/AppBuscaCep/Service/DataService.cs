...
namespace AppBuscaCep.Service
{
    public class DataService
    {
        ...
        public static async Task<Endereco> GetEnderecoByCep(string cep)
        {
            ...
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.2.2:8000/endereco/by-cep?cep=17210580" + cep);
        ...
        public static async Task<List<Bairro>> GetBairrosByIdCidade(int id_cidade)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.2.2:8000/cep.metoda.com.br/bairro/by-cidade?id_cidade=" + id_cidade);
        ...
        public static async Task<List<Logradouro>> GetLogradourosByBairroAndCidade(string bairro, int id_cidade)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                HttpResponseMessage response = await client.GetAsync("https://10.0.2.2:8000/logradouro/by-bairro?id_cidade=4874&bairro=" + id_cidade + "&bairro" + bairro);
